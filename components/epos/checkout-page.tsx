            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span
                  className={cn(
                    "text-sm font-bold",
                    paymentStatus === "unpaid" ? "text-destructive" : "text-card-foreground"
                  )}
                >
                  Not Paid
                </span>
              ...
              >
                ...
                <span
                  className={cn(
                    "text-sm font-bold",
                    paymentStatus === "paid" ? "text-[oklch(0.65_0.2_145)]" : "text-card-foreground"
                  )}
                >
                  Paid
                </span>
            ...
            {paymentStatus === "paid" && (
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className={cn("text-sm font-bold", paymentMethod === "cash" ? "text-primary" : "text-card-foreground")}>
                    Cash
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span className={cn("text-sm font-bold", paymentMethod === "card" ? "text-primary" : "text-card-foreground")}>
                    Card
                  </span>
                </button>
              </div>
        ...
        <div className="flex h-full flex-col overflow-hidden rounded-xl border border-border bg-card">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
            <div className="flex flex-col gap-2">
              {basket.map((entry) => {
                const unitPrice = entry.item.price + (entry.selectedVariation?.priceModifier ?? 0)
                ...
                return (
                  ...
                  >
                    ...
                    {(entry.addOns.length > 0 || entry.customAddOns.length > 0 || entry.comment) && (
                      <div className="mt-1.5 flex flex-col gap-0.5">
                        {entry.addOns.map((a) => (
                          <p key={a.addOn.id} className="text-[11px] text-primary">
